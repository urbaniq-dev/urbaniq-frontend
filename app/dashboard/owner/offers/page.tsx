...
export default function OwnerOffersPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Received Offers</h1>
        <p className="text-muted-foreground mt-1">Review and respond to cash offers from potential buyers.</p>
      </div>
      ...
      {offers.length === 0 ? (
        <div className="text-center py-20 bg-muted/30 rounded-xl border border-dashed">
          ...
          <p className="text-muted-foreground mb-6">You haven't received any offers for your properties.</p>
        </div>
      ) : (
            ...
            <div key={offer._id} className="p-6 bg-card rounded-xl border shadow-sm space-y-4">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b pb-4">
                <div className="space-y-1">
                  ...
                  <Link href={`/dashboard/owner/properties/${offer.propertyId?._id}`} className="text-xl font-bold hover:underline inline-block">
